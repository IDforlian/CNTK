...
public:
    ...
    ComputationNodePtr LatticeFreeMMI(const ComputationNodePtr label, const ComputationNodePtr prediction, const ComputationNodePtr logPrior, const ComputationNodePtr tmap, const ComputationNodePtr smap, ElemType acweight, bool usePrior, const std::wstring nodeName = L"");
